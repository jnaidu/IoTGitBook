...
On the incoming events from the device, we can attach policies to detect if a certain condition has met. In the rental car use case, we want to detect if the engine fault code is greater than default value 10000.
