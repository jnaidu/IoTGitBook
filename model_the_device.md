...
First, create the library of attributes that are required to represent a car. Second, create a library of events to be sent by the gateway on the car can send. Finally, all the required attributes and events required to represent a car are used to create a device template.
